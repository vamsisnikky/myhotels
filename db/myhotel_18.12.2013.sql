...
--
-- Host: localhost
-- Generation Time: Dec 18, 2013 at 10:02 PM
...
INSERT INTO `customers` (`iCustomerId`, `vFirstName`, `vLastName`, `vDob`, `vAddress1`, `vAddress2`, `iCountryId`, `iStateId`, `iCityId`, `iZip`, `vPhone`, `vEmail`, `vPassword`, `eStatus`) VALUES
(1, 'Vamsi', 'Snikky', '1992-12-09', '#969, Sharanam - 5 ', 'Jodhpur', 82, 12, 24, 350017, 8238566278, 'vamsisnikky@mailinator.com', NULL, 'Active');
...
(1, 'Hyatt Ahmedabad', 'Step into a world of ease, luxury and Swiss hospitality at The Stamford, our 5-star deluxe hotel. Located in the heart of the city amidst world-class shopping, entertainment and the CBD', 'Hyatt.jpg', 'Near Vastrapur Lake', 82, 12, 24, '(079) 61601234', 'Active', 'Yes', 'http://goo.gl/9lun7h'),
...
CREATE TABLE IF NOT EXISTS `hotel_rooms` (
  ...
  `fDiscountedPrice` float NOT NULL,
...
INSERT INTO `hotel_rooms` (`iHotelRoomId`, `iHotelId`, `vRoomType`, `iRoomDescription`, `iCount`, `iMaxAdult`, `iMaxChild`, `iBeds`, `iBathrooms`, `fPrice`, `fDiscountedPrice`, `iAvailableCount`, `vRoomImage`, `eStatus`) VALUES
(1, 1, 'Hyatt King/twin', 'Spacious and well-furnished, the rooms have all the modern amenities, including mini bar, 32'' LCD TV, safe, Wi-Fi, and tea/coffee maker.', 12, 2, 2, 2, 2, 8500, 7650, 8, 'hyatt1.jpg', 'Active'),
(2, 1, 'Hyatt Club King', 'Spacious and well-furnished, the rooms have all the modern amenities, including mini bar, 32'' LCD TV, safe, Wi-Fi, and tea/coffee maker.', 10, 2, 2, 2, 2, 9500, 8550, 5, 'hyatt2.jpg', 'Active'),
(3, 1, 'Hyatt Suite', 'Spacious and well-furnished, the rooms have all the modern amenities, including mini bar, 32'' LCD TV, safe, Wi-Fi, and tea/coffee maker.', 8, 2, 2, 2, 2, 12000, 10800, 3, 'hyatt3.jpg', 'Active'),
(4, 2, 'Superior Room Twin', 'Guest can avail facilities like Wi-Fi internet, guide services, babysitting services, transfer, room service, sightseeing and temple drop & pick up at an additional cost. Complimentary services include handicap facilities, parking facility, doctor on call, DVDs on request and travel desk ', 15, 2, 2, 2, 2, 8000, 7200, 10, 'novotel1.jpg', 'Active'),
(5, 2, 'Superior Room King', 'Guest can avail facilities like Wi-Fi internet, guide services, babysitting services, transfer, room service, sightseeing and temple drop & pick up at an additional cost. Complimentary services include handicap facilities, parking facility, doctor on call, DVDs on request and travel desk ', 8, 2, 2, 2, 2, 8500, 7650, 5, 'novotel2.jpg', 'Active');
