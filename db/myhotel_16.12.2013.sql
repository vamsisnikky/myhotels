...
--
-- Host: localhost
-- Generation Time: Dec 16, 2013 at 08:11 PM
...
CREATE TABLE IF NOT EXISTS `home_gallery` (
  `iGalleryId` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hotels` (
  ...
  `vContactNumber` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hotel_rooms` (
  ...
  `iBathroooms` int(11) DEFAULT NULL,
...
ALTER TABLE `hotel_rooms`
  ADD CONSTRAINT `hotel_rooms_ibfk_2` FOREIGN KEY (`iRoomId`) REFERENCES `rooms` (`iRoomId`),
